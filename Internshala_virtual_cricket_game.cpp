...
public:
 ...
 //function defination, we created all function defination here and then we write the body via scope_Resolution
    void welcome(); 
    void enter();
    void pool();
...
//writing player function body using scope resolution 
Player::Player()
{
    runsScored=0;
    ballsPlayed=0;
...
//writing Team function body using scope resolution 
Team::Team(){
    totalRunsScored=0;
    wicketsLost=0;
    totalBallsBowled=0;
...
//writing Game function body using scope resolution 
Game::Game()
{
    playersPerTeam=5;
    maxballs=6;
...
///writing welcome function body using scope resolution which is first screen
void Game::welcome()
{
    cout<<"-----------------------------------------------"<<endl;
    cout<<"|===================CRIC-IN===================|"<<endl;
